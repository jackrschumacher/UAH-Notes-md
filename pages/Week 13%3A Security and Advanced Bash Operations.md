      ...
      - For example, using systemctl:
        ...
        - Basic syntax:
          - ```bash
            ...
            command [action] [#Start](Start.html), stop,etc.
            unit [systemd unit] [#Like](Like.html) a service, ex: nginx.service
            ```
          - ![Common systemctl commands](../assets/image_1763430376613_0.png)
...
### Auditing Network Configurations
      ...
      - Scripts to list open ports- use **netstat**
        - ```bash
          sudo netstat -tulnp [#Lists](Lists.html) all ports and thier associated proccesses
          ```
